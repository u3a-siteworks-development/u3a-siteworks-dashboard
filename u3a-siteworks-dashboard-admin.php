...
<p>The standard WordPress Dashboard will be replaced to show this information panel for all users with the role of 
'author' or 'contributor' when they log in.  
You might want to use the panel to remind users of the steps to edit 
content or to provide links to your own documentation.</p>
...
<input type="text" name="u3a_dashboard_panel_title" id="u3a_dashboard_panel_title" 
value="$u3a_dashboard_panel_title" class="regular-text">
</p>
...
<input type="checkbox" id="u3a_dashboard_panel_showall" name="u3a_dashboard_panel_showall" 
value="1" $u3a_dashboard_panel_showall_chk>
</p>
...
function u3a_dashboard_save_settings()
{
    ...
    $u3a_dashboard_panel_title = isset($_POST['u3a_dashboard_panel_title']) ?
         sanitize_text_field($_POST['u3a_dashboard_panel_title']) : '';
    if ($needStripSlashes) {
